...
\begin{tabular}{lccc}
\hline
Kategoria & Clopper-Pearson & Wilson & Wald \\
\hline
Bardzo niezadowolony & [0.032, 0.130] & [0.036, 0.132] & [0.024, 0.112] \\
Niezadowolony        & [0.042, 0.149] & [0.047, 0.150] & [0.034, 0.136] \\
Nie ma zdania        & [0.132, 0.282] & [0.137, 0.282] & [0.127, 0.273] \\
Zadowolony           & [0.407, 0.593] & [0.410, 0.590] & [0.409, 0.591] \\
Bardzo zadowolony    & [0.087, 0.220] & [0.092, 0.221] & [0.081, 0.209] \\
\hline
\end{tabular}
\caption{Porównanie przedziałów ufności dla udziału odpowiedzi w poszczególnych kategoriach}
\end{table}
...
Kategoria & Clopper-Pearson & Wilson & Wald \\
\hline
Bardzo niezadowolony & 0.098 & 0.096 & 0.093 \\
Niezadowolony        & 0.107 & 0.103 & 0.102 \\
Nie ma zdania        & 0.150 & 0.145 & 0.146 \\
Zadowolony           & 0.185 & 0.179 & 0.182 \\
Bardzo zadowolony    & 0.133 & 0.128 & 0.128 \\
\hline
\end{tabular}
\caption{Porównanie długości przedziałów ufności dla udziału odpowiedzi}
\end{table}

Przedziały ufności  dla udziału odpowiedzi w poszczególnych kategoriach są do siebie zbliżone, choć zauważalne są różnice w ich szerokości. Przedziały wyznaczone metodą Walda są zazwyczaj węższe, jednak znane są z mniejszej dokładności przy małych licznościach. Metoda Cloppera–Pearsona, będąca metodą dokładną, daje najbezpieczniejsze i najszersze przedziały. W przypadku największej kategorii ("Zadowolony") wszystkie metody wskazują stosunkowo wąski i zbliżony przedział, co wynika z dużej liczby obserwacji. Dla skrajnych kategorii, gdzie liczności są mniejsze, różnice pomiędzy metodami stają się bardziej zauważalne.
...
Funkcja zwraca tabelę z wynikami testu: statystykę, p-value oraz wartość krytyczną.
...
\hline
\textbf{Test} & \textbf{Statystyka} & \textbf{P-value} & \textbf{Wartość krytyczna} \\
\hline
Chi-kwadrat Pearsona & 17{,}15 & 0{,}0018 & 9{,}4877 \\
Chi-kwadrat największej wiarygodności & 17{,}60 & 0{,}0015 & 9{,}4877 \\
\hline
\end{tabular}
\end{table}
...
wiarygodności dały wysokie wartości statystyk testowych
 oraz p-value bliskie $0.001$.\
...
"zdecydowanie się zgadzam" na pytanie PYT_1.

Postawiono hipotezy:

-   $H_0$: rozkład odpowiedzi jest równomierny $(p1 = p2 = … = p5 = 0.2)$,

-   $H_1$: rozkład odpowiedzi różni się od równomiernego


Do weryfikacji hipotezy zastosowano dwa testy chi-kwadrat: test Pearsona oraz test najwięk
szej wiarygodności.Przyjęto poziom istotności
$0.05$.
...
\textbf{Test} & \textbf{Statystyka} & \textbf{P-value} & \textbf{Wartość krytyczna} \\
\hline
Chi-kwadrat Pearsona & 64{,}8571 & 0{,}0000 & 9{,}4877 \\
Chi-kwadrat największej wiarygodności & 52{,}5271 & 0{,}0000 & 9{,}4877 \\
\hline
\end{tabular}
\end{table}


Zarówno dla testu chi-kwadrat Pearsona jak i testu największej wiarygodności, otrzymane wartości statystyk są większe od wartości krytycznej, co oznacza, że na poziomie istotności $0.05$ istnieją podstawy do odrzucenia hipotezy zerowej o zgodności rozkładu odpowiedzi z rozkładem teoretycznym. Oznacza to, że rozkład odpowiedzi na PYT_1 nie
jest równomierny — nie wszystkie odpowiedzi są jednakowo prawdopodobne.
...
Korzystając z funkcji poznanej w zadaniu 6. zweryfikowano hipotezę, że
stopień zadowolenia ze szkoleń w kontekście dopasowania do
indywidualnych potrzeb w pierwszym badanym okresie nie zależy od
zajmowanego stanowiska. Przyjęto poziom istotności 0.01.\


Zatem hipotezą zerową jest $H_0$: PYT_2 i CZY_KIER są niezależne.


Hipotezą alternatywną jest $H_1$: PYT_2 i CZY_KIER są zależne.
